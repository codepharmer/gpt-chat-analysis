...
def _process_parts(parts: List[Any]) -> str:
    """Process parts array, converting non-string objects to formatted placeholders."""
    result = []
    for part in parts:
        if isinstance(part, str):
            ...
            result.append(f"<Data:{type(part).__name__}>")
    return "".join(result)
